...
# Choose a connection type - LTE or WIFI and initialize the connection name and interface -------------------------------------------
while true
do
	...
	then
		# Check if a preffered WIFI connection is available
...
# ----------------------------------------------------------------------------------
# Connect to the chosen connection (LTE or WIFI) and start the VPN service ---------
while true
do
